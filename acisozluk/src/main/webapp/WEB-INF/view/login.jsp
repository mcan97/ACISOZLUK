...
<body>
	...
	<main class="">
		...
		%>
		<form action="/acisozluk/login" method="post" class="reg-form">
			<label for="username">Kullanıcı Adı: </label>
			<input id="username" type="text" name="username" placeholder="Kullanıcı Adınızı Girin">
			<label for="password">Şifre: </label>
			<input id="password" type="password" name="password" placeholder="Şifrenizi Girin...">
